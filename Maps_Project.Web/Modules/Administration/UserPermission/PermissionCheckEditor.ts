...
import { DataGrid, Decorators, Dictionary, GridUtils, Grouping, IGetEditValue, ISetEditValue, SlickFormatting, SlickTreeHelper, ToolButton, any, count, getRemoteDataAsync, htmlEncode, localText, toGrouping, trimToNull, tryGetText, turkishLocaleCompare } from "@serenity-is/corelib";
import { Column } from "@serenity-is/sleekgrid";

@Decorators.registerEditor('Maps_Project.Administration.PermissionCheckEditor', [IGetEditValue, ISetEditValue])
